...
public class PaymentUtils {
	...
	public static String encrypt(String content, String publicKey) throws Exception {
		...
		if (encryptBytes.length <= ENCRYPT_BlOCK_SIZE) {
			...
			for (int i = 0; i < index; i++) {
				...
				blockBytes = org.apache.commons.lang.ArrayUtils.subarray(encryptBytes, startIndex, endIndex);
				if (buffer == null) {
					buffer = encrypt(blockBytes, publicKeyBytes);
				} else {
					buffer = org.apache.commons.lang.ArrayUtils.addAll(buffer, encrypt(blockBytes, publicKeyBytes));
				}
	 ...
	 * @throws Exception
	 */
	public static String decrypt(String content, String privateKey) throws UnsupportedEncodingException, InvalidKeyException, NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeySpecException, IllegalBlockSizeException, BadPaddingException  {
...
////				return ConfigTool.signMessage("888888888888888", content);
////			}
...
//	}
	...
	public static byte[] decrypt(byte[] decrypt, byte[] privateKeyBytes) throws NoSuchAlgorithmException, NoSuchPaddingException, InvalidKeySpecException, InvalidKeyException, IllegalBlockSizeException, BadPaddingException {
	...
	public static PrivateKey codeToPrivateKey(byte[] privateKey) throws NoSuchAlgorithmException, InvalidKeySpecException  {
